                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" action="<?= base_url('auth/cek_login'); ?>" method="POST">
                                ...
                                <button type="submit" name="tambah" class="btn btn-primary float-right">Log In</button>
                                ...
                                <div class="text-center mt-4 font-weight-light"> Don't have an account? <a
                                        href="<?= base_url() ?>auth/registrasi"  class="text-primary">Create</a>
                                </div>
                            </form>
                        </div>
                    </div>  
