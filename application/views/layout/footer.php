        ...
        <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
                <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Politeknik Caltex Riau</span>
                <span class="float-none float-sm-end mt-1 mt-sm-0 text-end"> Prodi <a
                        href="https://psti.pcr.ac.id/" target="_blank">Teknik Informatika</a> 2023/2024</span>
            </div>
        </footer>
        <!-- partial -->
    </div>
